...
func TestDecodeTwoMessagesMavlink2(t *testing.T) {
	// decode a known good byte stream
...
func TestDecodeTwoMessagesMixedMavlink(t *testing.T) {
	// decode a known good byte stream
	pktbytes := []byte{0xFD, 0x0D, 0x00, 0x00, 0x8A, 0x02, 0xFC, 0x04, 0x00, 0x00, 0xE5, 0xF2, 0x41, 0x21, 0x09, 0x7E, 0x3B, 0x16, 0x00, 0x00, 0x01, 0x00, 0x6B, 0x4A, 0x83,
		0xfe, 0x0e, 0x00, 0xfe, 0x0e, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x39, 0x30, 0x00, 0x00, 0x00, 0x00, 0x45, 0x40}
	decoder := NewDecoder(bytes.NewBuffer(pktbytes))
