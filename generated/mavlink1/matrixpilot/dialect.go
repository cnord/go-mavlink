...
const (
	// MAV_PFS_CMD_READ_ALL enum. Read all parameters from storage
	MAV_PFS_CMD_READ_ALL MAV_PREFLIGHT_STORAGE_ACTION = 0
	// MAV_PFS_CMD_WRITE_ALL enum. Write all parameters to storage
	MAV_PFS_CMD_WRITE_ALL MAV_PREFLIGHT_STORAGE_ACTION = 1
	// MAV_PFS_CMD_CLEAR_ALL enum. Clear all  parameters in storage
	MAV_PFS_CMD_CLEAR_ALL MAV_PREFLIGHT_STORAGE_ACTION = 2
	// MAV_PFS_CMD_READ_SPECIFIC enum. Read specific parameters from storage
	MAV_PFS_CMD_READ_SPECIFIC MAV_PREFLIGHT_STORAGE_ACTION = 3
	// MAV_PFS_CMD_WRITE_SPECIFIC enum. Write specific parameters to storage
	MAV_PFS_CMD_WRITE_SPECIFIC MAV_PREFLIGHT_STORAGE_ACTION = 4
	// MAV_PFS_CMD_CLEAR_SPECIFIC enum. Clear specific parameters in storage
	MAV_PFS_CMD_CLEAR_SPECIFIC MAV_PREFLIGHT_STORAGE_ACTION = 5
	// MAV_PFS_CMD_DO_NOTHING enum. do nothing
