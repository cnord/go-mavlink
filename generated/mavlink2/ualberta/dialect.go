...
const (
	MODE_MANUAL_DIRECT UALBERTA_AUTOPILOT_MODE = 1 // Raw input pulse widts sent to output
	MODE_MANUAL_SCALED UALBERTA_AUTOPILOT_MODE = 2 // Inputs are normalized using calibration, the converted back to raw pulse widths for output
	MODE_AUTO_PID_ATT  UALBERTA_AUTOPILOT_MODE = 3 // dfsdfs
	MODE_AUTO_PID_VEL  UALBERTA_AUTOPILOT_MODE = 4 // dfsfds
...
const (
	...
	NAV_AHRS         UALBERTA_NAV_MODE = 2 // AHRS mode
	NAV_INS_GPS_INIT UALBERTA_NAV_MODE = 3 // INS/GPS initialization mode
...
const (
	PILOT_MANUAL UALBERTA_PILOT_MODE = 1 // sdf
	PILOT_AUTO   UALBERTA_PILOT_MODE = 2 // dfs
